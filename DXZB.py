...
urls = []
# shengshi_names = ["湖南", "湖北", "广东", "广西", "江西", "江苏", "浙江", "安徽", "河南", "四川", "贵州", "云南",
#                   "河北", "山西", "陕西", "福建", "海南", "山东", "辽宁", "吉林", "黑龙江", "甘肃", "青海"]
shengshi_names = ["岳阳", "长沙", "株洲", "湘潭", "衡阳", "邵阳", "常德", "娄底", "益阳", "郴州", "永州", "怀化", "张家界"]
...
for shengshi in pinyin_names:
    for operator_name, org_name in operators.items():
        ...
        search_txt = f'"iptv/live/zh_cn.js" && country="CN" && city="{shengshi}" && org="{org_name}"'  # 构造查询城市字符串
        # 将字符串编码为字节流
