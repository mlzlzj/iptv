...
def download_speed_test():
    while not speed_test_queue.empty():
        ...
        # 如果下载速率大于或等于0.1MB/s，则添加到测速结果列表中
    ...
    with open('iptv.txt', 'r', encoding='utf-8') as file:
        for line in file:
            ...
            if len(channel_info) >= 2:  # 假设至少有名称和URL
                ...
                print(f"跳过不完整的频道信息: {line.strip()}")


# 获取组播源频道列表并将所有频道列表文件写入iptv.txt中
def get_multicast_sources(url_list):
    headers = {
    ...
    channelsx = [
        ...
        "CCTV女姓时尚,http://8.8.8.8:8/udp/239.76.254.55:9000",
        "CCTV央视文化精品,http://8.8.8.8:8/udp/239.76.254.56:9000",
        ...
        "CCTV电视指南,http://8.8.8.8:8/udp/239.76.254.61:9000",
        "CCTV央视高尔夫,http://8.8.8.8:8/udp/239.76.254.62:9000",
